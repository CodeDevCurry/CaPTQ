...
from .observer import MSEObserver, EMAMSEObserver,  MSEFastObserver, MinMaxObserver, AvgMinMaxObserver, AvgMSEObserver, AvgMSEFastObserver
from .fake_quant import AdaRoundFakeQuantize, LSQFakeQuantize, FixedFakeQuantize, LSQPlusFakeQuantize
import torch.nn.functional as F

ObserverDict = {
    'MSEObserver':              MSEObserver,
    'EMAMSEObserver':           EMAMSEObserver,
